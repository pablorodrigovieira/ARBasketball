...
//  ARBasketball
//
//  Created by Pablo Vieira on 22/8/18.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    @objc func handleTap(gestureRecognizer: UIGestureRecognizer){
        ...
        // Transform matrix
        // Orientation and location of the camera to determine the position of the camera
        // and its at this point in which we want the ball to be placed.
